...
\begin{equation}
    \theta^\ast \triangleq \triangleq \argmax_{\theta}\EE_{x_1 \sim \pdata} \left[\mathcal{L}(x_1;\theta)\right]\\
...
To get a handle on them, we must first get a grip on the activation gradients $\frac{\partial \mathcal{L}}{\partial x_t}$.
